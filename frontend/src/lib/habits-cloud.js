...
export async function fetchLogsFromCloud(userId) {
    const supabase = await getSupabase();
    const { data, error } = await supabase
        .from("habit_logs")
        .select("*")
...
export async function saveHabitToCloud(habit, userId, position) {
    const supabase = await getSupabase();
...
export async function updateHabitInCloud(habit) {
    const supabase = await getSupabase();
...
export async function reorderHabitsInCloud(habits) {
    const supabase = await getSupabase();
...
export async function toggleLogInCloud(habitId, date, userId, exists) {
    const supabase = await getSupabase();
    if (exists) {
        const { error } = await supabase
            .from("habit_logs")
